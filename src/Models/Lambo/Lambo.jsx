...
export default function Lambo() {
  return (
    <Canvas gl={{ logarithmicDepthBuffer: true, antialias: false }} dpr={[1, 1.5]} camera={{ position: [0, 0, 15], fov: 25 }} style={{ width: '40vw', height: '60vh', position: 'absolute', top: '20%', right: '100' }}>
