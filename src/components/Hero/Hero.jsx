        ...
        <div className='Hero z-1 pointer-events-none'>
            ...
            <div className="svgdiv flex content-center">
                <div className="SVG flex flex-items-center flex-justify-between">
                    <a className='tooltip pointer-events-auto invert' data-title='Instagram' target='_blank' href="https://www.instagram.com/abhijeetdhikale007"><img className='lg:w-8 w-10' src="/assets/Skills/Instagram2.svg" alt="Instagram" /></a>
