    ...
    return (
        <div className="Education" id='Education'>
            ...
            <div className='EduDiv mt-37 lg:mt-35'>
                <img src="public/assets/Education/New-English-School.png" alt="School Logo" />
            ...
            <div className='EduDiv lg:sm-ml-15 sm:sm-ml-10'>
                <img src="public/assets/Education/NDMVP-ITI.png" alt="College Logo" />
            ...
            <div className='EduDiv mb-12 lg:mb-0 lg:sm-ml-15 sm:sm-ml-10'>
                <img className='METLogo' src="public/assets/Education/MET-College.png" alt="College Logo" />
